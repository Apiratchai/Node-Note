...
function Index() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div role="button" className="flex flex-row justify-start m-2" onClick={goToLandPage}>
        <ArrowLeft />
      ...
      <section className="w-screen flex-1 mt-12">
        <div className="flex justify-start items-center flex-col gap-6">
          ...
          <p className="text-2xl uppercase font-light">CoE33 Nodenote Group section2 friday</p>
